...
{
	string img1 = "F:\\work\\math model\\test\\OpenCV_SFM-master\\OpenCV_SFM\\image\\0004.png";
	string img2 = "F:\\work\\math model\\test\\OpenCV_SFM-master\\OpenCV_SFM\\image\\0006.png";
...
)
{
	...
	//Ptr<Feature2D> sift = cv::SIFT::create(0, 3, 0.04, 10);
